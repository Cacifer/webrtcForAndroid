...
public class WebRTCDemo extends TabActivity implements IViEAndroidCallback,
  ...
  //  private static final int INIT_BITRATE = 500;
    //初始化针率,设置过高，解码器和网速都接受不了
    private static final int INIT_BITRATE = 150;
  //  private static final String LOOPBACK_IP = "127.0.0.1";
    private static final String LOOPBACK_IP = "10.2.42.195";
 ...
 //   private int receivePortVideo = 11111;
    private int receivePortVideo = 8808;
    private TextView etVTxPort;
 //  private int destinationPortVideo = 11111;
    private int destinationPortVideo = 8088;
    ...
    private void startMain() {
        ...
        cbEnableVideoRTPDump.setChecked(true);  
        ...
        cbEnableVoiceRTPDump.setChecked(true);
    ...
    private void startReceive(){
    	...
    	isReceiverStart = true;
    	
    }
    private boolean isReceiverStart = false;
